...
case $opcao in
  1)
    ...
    imageName="debian-12-backports-genericcloud-amd64-daily.qcow2"
    volumeName="local-lvm"
    virtualMachineId="303"
    templateName="Debian12CloudInitRancher"
    tmp_cores="2"
    tmp_memory="3500"
    ;;
  2)
    ...
    templateName="Debian12CloudInitAgente"
    tmp_cores="2"
    tmp_memory="3500"
    ;;
  3)
    ...
    templateName="Debian12CloudInitComum"
    tmp_cores="2"
    tmp_memory="3500"
    ;;
  *)
